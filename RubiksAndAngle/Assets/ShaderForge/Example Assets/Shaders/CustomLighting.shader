...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _OutLine ("OutLine", Range(0, 0.5)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                return fixed4(_OutColor_var.rgb,0);
            }
            ENDCG
        }
        Pass {
